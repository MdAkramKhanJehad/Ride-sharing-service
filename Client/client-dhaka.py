...
def message(data):
    ...
    r = requests.post("http://dhaka.server.com:80/rating", json=d)
...
while True:
    ...
    r = requests.post("http://dhaka.server.com:80/ridesharingservice/rider", json=rider)
    ...
    r = requests.post("http://dhaka.server.com:80/ridesharingservice/driver", json=driver)
